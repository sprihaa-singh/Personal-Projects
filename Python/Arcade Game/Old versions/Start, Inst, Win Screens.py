...
class StartView(arcade.View):
    # What will happen when the screen first reveals itself
    def on_show(self):
    ...
    # When Player presses on mouse, the next screen will open
...
# From Instructions Screen or Game Over Screen. Where players select a character
class CharSel(arcade.View):
    def __init__(self):
        ...
        # load background image with all 4 character options
    ...
    # Draws instructions to screen on top of background
    def on_draw(self):
