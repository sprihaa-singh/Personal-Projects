...
class InstructionView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Don't get caught by the zombie! He can travel through walls.",SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 + 70, arcade.color.BLACK, font_size=20, anchor_x="center")
